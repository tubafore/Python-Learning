...
class CoffeeMachine:
    ...
    def __init__(self):
        ...
        self.menuOptions.extend(['report', 'refill', 'off'])
        self.moneyOptions = []
    ...
    def _handleDrinkChoice(self, menuChoice:str):
        ...
        if self._hasResources(choice):
            ...
            while inserted < cost:
                ...
                elif coin == "q" or coin == "quarter":
                    inserted += self.money["quarter"]["value"]
                else:
                    inserted += self.money["dollar"]["value"]
            if inserted >= cost:
    ...
    def _hasResources(self, choice:dict) -> bool:
        for ingredient in choice["ingredients"]:
            if not self.resources[ingredient] >= choice["ingredients"][ingredient]:
